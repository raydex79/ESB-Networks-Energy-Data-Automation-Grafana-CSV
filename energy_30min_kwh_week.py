...
# === SETTINGS ===
input_file = 'energy_30min_kwh.csv'  # Your input file
output_directory = '/folder/path'  # <-- Change this to your folder
output_filename = 'energy_30min_kwh_week.csv'
...
df['Read Date and End Time'] = pd.to_datetime(df['Read Date and End Time'], format='%Y-%m-%d %H:%M')
